...
Source0  : https://cran.r-project.org/src/contrib/leaflet_2.2.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699922325

%install
export SOURCE_DATE_EPOCH=1699922325
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/R-leaflet
cp %{_builddir}/leaflet/LICENSE.note %{buildroot}/usr/share/package-licenses/R-leaflet/e642c7c2169b2e4ebd90105980fa275b25af48c0 || :
...
/usr/share/package-licenses/R-leaflet/e642c7c2169b2e4ebd90105980fa275b25af48c0
